...
/**
 * Custom hook for calling the prediction API for both models with debouncing, caching, and retry logic
 *
 ...
 * @returns {Object|null} data - Prediction result with {decision_tree, xgboost}
 * @returns {boolean} loading - True when request is in progress
 * @returns {Error|null} error - Error object if request failed
 *
 * @example
 * const {data, loading, error} = usePredictBoth({sex: 0, pclass: 1, age: 30, fare: 84});
 */
function usePredictBoth(params) {
