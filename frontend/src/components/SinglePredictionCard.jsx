...
function SinglePredictionCard({ passengerData, label, onEdit, onHighlightCohort, messageIndex }) {
  ...
  if (loading) {
    return (
      <div className="p-0 rounded-lg relative" style={{ backgroundColor: UI_COLORS.cardBg, borderWidth: '1px', borderStyle: 'solid', borderColor: UI_COLORS.cardBorder }}>
        ...
        <div className="mt-3 grid grid-cols-2 gap-0" style={{ paddingLeft: '28px' }}>
  ...
  return (
    <div className="p-4 rounded-lg relative" style={{ backgroundColor: UI_COLORS.cardBg, borderWidth: '1px', borderStyle: 'solid', borderColor: UI_COLORS.cardBorder }}>
      ...
      <p className="mb-0" style={{ fontSize: FONTS.ui.cardLabel, color: UI_COLORS.textSecondary, fontWeight: FONT_WEIGHTS.normal, paddingLeft: '28px' }}>{label}</p>

      <div className="grid grid-cols-2 gap-0" style={{ paddingLeft: '0px' }}>
        {/* Decision Tree */}
        <div
        ...
        >
          <div>
            <div className="mb-" style={{ fontSize: FONTS.ui.cardSubtext, color: UI_COLORS.textSecondary }}>Decision Tree</div>
            <button
        ...
        >
          <div>
            <div className="mb-0" style={{ fontSize: FONTS.ui.cardSubtext, color: UI_COLORS.textSecondary }}>XGBoost</div>
            <button
              onClick={onHighlightCohort ? () => onHighlightCohort(passengerData, null, messageIndex) : undefined}
              className={onHighlightCohort ? "mb-2 hover:underline cursor-pointer" : "mb-2"}
